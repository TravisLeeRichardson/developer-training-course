...
var {BufferUtility} = import ("bufferutility"); 

const {Reader} = import("ckb-js-toolkit");
const {Uint64LE} = import("int64-buffer");
...
export function typedArrayToBuffer(uint8Array)
{
